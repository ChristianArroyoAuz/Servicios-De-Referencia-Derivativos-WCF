...
namespace ServicioCapitales
{
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            ServiceHost anfitrion = new ServiceHost(typeof(ServicioCapitales.InformacionPais));
            //Agregamos el extremo de servicio y el puerto de escucha
            anfitrion.AddServiceEndpoint(typeof(ServicioCapitales.IInformacionPais), new NetTcpBinding(), "net.tcp://localhost:8080");
